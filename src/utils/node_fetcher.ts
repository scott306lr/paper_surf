...
const FetchPaper = async (paperId: string) => {
    const fieldsString = ['title', 'url', 'publicationVenue', 'externalIds', 'year', 'abstract', 'referenceCount', 'citationCount', 'influentialCitationCount',
        ...
        'citations.title', 'citations.publicationVenue', 'citations.year', 'citations.externalIds', 'citations.publicationTypes', 'citations.publicationDate', 'citations.journal',
        'references.title', 'references.publicationVenue', 'references.year', 'references.externalIds', 'references.publicationTypes', 'references.publicationDate', 'references.journal'].join();
